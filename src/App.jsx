...
// ── ProfileDropdown ───────────────────────────────────────────────────────────
function ProfileDropdown({ userName, setUserName, avatarSrc, onAvatarChange, onNavigate, onClose, todayRef }) {
...
export default function App() {
  ...
  useEffect(() => {
    setPageData(prev => {
      ...
      [leftKey, rightKey].forEach(k => { if (!(k in next)) { next[k] = loadPage(k); changed = true; } });
